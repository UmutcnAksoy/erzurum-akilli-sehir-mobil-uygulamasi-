...
// Bu ekran, Otel ve Apartları gösterecek şekilde tasarlanmıştır.

class LodgingPoiScreen extends StatefulWidget {
  const LodgingPoiScreen({super.key});

  @override
  State<LodgingPoiScreen> createState() => _LodgingPoiScreenState();
}

class _LodgingPoiScreenState extends State<LodgingPoiScreen> {
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              // KRİTİK: KOLEKSİYON ADI 'hotel' OLARAK AYARLANDI.
...
// Alt widgetlar: POIListTestScreen'den kopyalanmıştır.
